function Header() {
    return(
        <>
        <div className="bg-white text-white font-Roboto h-12 pl-10 flex flex-row items-center">
            <div className="w-1/2">
            ...
            <div className="w-1/2 flex justify-end items-center pr-4 space-x-3">
                <button>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" color="#000000" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
